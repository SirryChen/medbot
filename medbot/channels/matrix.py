...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install medbot[matrix]"
    ) from e
...
from medbot.config.paths import get_data_dir, get_media_dir
from medbot.config.schema import Base
from medbot.utils.helpers import safe_filename

...
from medbot.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from medbot.agent.tools.registry import ToolRegistry
from medbot.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("medbot.agent.tools.mcp.logger.warning", _warning)

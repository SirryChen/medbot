...
from medbot.config.schema import ChannelsConfig
...
def test_discover_plugins_loads_entry_points():
    from medbot.channels.registry import discover_plugins
...
def test_builtin_channel_default_config():
    ...
    from medbot.channels.telegram import TelegramChannel

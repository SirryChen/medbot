...
from medbot.cli import commands
...
def mock_prompt_session():
    ...
    with patch("medbot.cli.commands._PROMPT_SESSION", mock_session), \
         patch("medbot.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("medbot.cli.commands.PromptSession") as MockSession, \
         patch("medbot.cli.commands.FileHistory") as MockHistory, \
